    ...
    ERC721URIStorageUpgradeable
{
    ...
    function getWeaponSubEdition(uint256 tokenId) public view returns (uint256) {
    ...
    function setNftVars(uint256 _tokenId, uint256 _key, uint256 _value) public gameMasterOnly {
        tokenVars[_tokenId][_key] = _value;
    }

    function getNftVars(uint256 _tokenId, uint256 _key) public view returns(uint256) {
